...
HD_PWD='/home/ryan/vivado/counter_verilog/counter_verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_verilog.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_verilog.tcl
