...
HD_PWD='/home/ryan/vivado/counter_verilog/counter_verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_verilog.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_verilog.tcl -notrace
