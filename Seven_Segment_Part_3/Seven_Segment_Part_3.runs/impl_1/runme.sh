...
HD_PWD='/home/ryan/vivado/Seven_Segment_Part_3/Seven_Segment_Part_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Segment_III.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seven_Segment_III.tcl -notrace
