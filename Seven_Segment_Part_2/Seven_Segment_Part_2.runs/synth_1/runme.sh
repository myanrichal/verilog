...
HD_PWD='/home/ryan/vivado/Seven_Segment_Part_2/Seven_Segment_Part_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Segment_II.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seven_Segment_II.tcl
